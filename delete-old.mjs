...
const result = await turso.execute('SELECT id, name, image_url FROM catalog');
console.log('Productos actuales:');
console.table(result.rows);

// Para eliminar uno específico, descomenta y cambia el ID:
// await turso.execute('DELETE FROM catalog WHERE id = "ID_AQUI"');
