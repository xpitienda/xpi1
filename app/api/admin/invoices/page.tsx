...
import Header from '@/components/Header'; // Asegúrate de que esta ruta sea correcta según tu proyecto
...
export default function InvoicesAdmin() {
  ...
  if (loading) return <div style={{ padding: '2rem', color: 'white' }}>Cargando factureros...</div>;
