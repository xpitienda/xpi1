...
export default function ProductImageCarousel({
  ...
  // Imágenes a mostrar (máximo 5, si hay menos, rellenar con logo)
  ...
  return (
    <div style={{
      ...
      >
        ...
        <div style={{
          position: 'relative',
          height: showCloseButton ? '500px' : '600px',
              ...
              {displayImages.map((img, index) => (
                <button
                  ...
                  style={{
                    ...
                    overflow: 'hidden',
                    border: index === currentIndex ? '3px solid #9333ea' : '3px solid #e5e7eb',
                    cursor: 'pointer',
