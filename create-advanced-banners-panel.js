  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f9fafb', padding: '2rem' }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <button onClick={() => { setShowForm(!showForm); setEditingId(null); }} style={{ background: '#3D1A78', color: 'white', padding: '1rem 2rem', borderRadius: '0.5rem', border: 'none', cursor: 'pointer', fontWeight: 'bold', fontSize: '1.1rem', marginBottom: '2rem' }}>
        ...
        {showForm && (
          <div style={{ background: 'white', padding: '2rem', borderRadius: '0.75rem', marginBottom: '2rem', boxShadow: '0 4px 6px rgba(0,0,0,0.05)' }}>
            ...
            <form onSubmit={handleSubmit} style={{ display: 'grid', gap: '1rem' }}>
              ...
              <input type="url" value={formData.image_url} onChange={e => setFormData({...formData, image_url: e.target.value})} required placeholder="URL de la imagen (ej: https://...)" style={{ padding: '0.75rem', border: '1px solid #ddd', borderRadius: '0.5rem' }} />
              ...
              {/* CHECKBOX PRINCIPAL DE VISIBILIDAD */}
...
console.log('✅ Panel de Banners Visuales creado correctamente en app/admin/advanced-banners/page.tsx');
