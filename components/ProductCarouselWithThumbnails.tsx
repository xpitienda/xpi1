...
export default function ProductCarouselWithThumbnails({
  ...
  const [showFullscreen, setShowFullscreen] = useState(false); // ← ÚNICA LÍNEA NUEVA #1
    ...
    <>
      <div style={{
        ...
        >
          ...
          {/* MINIATURAS VERTICALES - SIN CAMBIOS */}
          <div
            ref={thumbnailsRef}
            style={{
              width: '120px',
          ...
          {/* CARRUSEL 3D ORIGINAL - SIN CAMBIOS EN LA ESTRUCTURA */}
          <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
                ...
                {displayImages.map((image, index) => {
                  ...
                  return (
                    <div
                      ...
                      onClick={() => {
                        setSelectedImageIndex(index);
                        setShowFullscreen(true); // ← ÚNICA LÍNEA NUEVA #2
                      }}
                      style={{
                        position: 'absolute',
                        width: '200px',
                        ...
                        overflow: 'hidden',
                        cursor: 'zoom-in', // ← ÚNICA LÍNEA NUEVA #3
                        border: isSelected ? '3px solid #9333ea' : '2px solid transparent'
                      }}
                    >
                      <img
            ...
            {/* Info del producto y botón - SIN CAMBIOS */}
      ...
      {/* VISTA FULLSCREEN - TAMAÑO REAL (ÚNICO BLOQUE NUEVO) */}
      {showFullscreen && selectedImageIndex !== null && displayImages[selectedImageIndex] && (
        <div
          style={{
            position: 'fixed',
            inset: 0,
