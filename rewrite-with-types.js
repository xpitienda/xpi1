        ...
        {showForm && (
          <div style={{ background: 'white', padding: '2rem', borderRadius: '0.75rem', marginBottom: '2rem', boxShadow: '0 4px 6px rgba(0,0,0,0.05)' }}>
            ...
            <form onSubmit={handleSubmit} style={{ display: 'grid', gap: '1rem' }}>
              <input type="text" value={formData.title} onChange={(e: ChangeEvent<HTMLInputElement>) => setFormData({...formData, title: e.target.value})} required placeholder="Título interno (ej: Oferta Tenis Nike)" style={{ padding: '0.75rem', border: '1px solid #ddd', borderRadius: '0.5rem' }} />
              ...
              <input type="url" value={formData.link_url} onChange={(e: ChangeEvent<HTMLInputElement>) => setFormData({...formData, link_url: e.target.value})} placeholder="URL de destino al hacer clic (opcional)" style={{ padding: '0.75rem', border: '1px solid #ddd', borderRadius: '0.5rem' }} />
              
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '1rem' }}>
                <div>
                  <label style={{ display: 'block', marginBottom: '0.5rem', fontWeight: 'bold' }}>Fecha Inicio</label>
                  <input type="date" value={formData.start_date} onChange={(e: ChangeEvent<HTMLInputElement>) => setFormData({...formData, start_date: e.target.value})} style={{ width: '100%', padding: '0.75rem', border: '1px solid #ddd', borderRadius: '0.5rem', boxSizing: 'border-box' }} />
                </div>
                <div>
                  <label style={{ display: 'block', marginBottom: '0.5rem', fontWeight: 'bold' }}>Fecha Fin</label>
                  <input type="date" value={formData.end_date} onChange={(e: ChangeEvent<HTMLInputElement>) => setFormData({...formData, end_date: e.target.value})} style={{ width: '100%', padding: '0.75rem', border: '1px solid #ddd', borderRadius: '0.5rem', boxSizing: 'border-box' }} />
                </div>
                <div>
                  <label style={{ display: 'block', marginBottom: '0.5rem', fontWeight: 'bold' }}>Orden</label>
                  <input type="number" value={formData.display_order} onChange={(e: ChangeEvent<HTMLInputElement>) => setFormData({...formData, display_order: e.target.value})} style={{ width: '100%', padding: '0.75rem', border: '1px solid #ddd', borderRadius: '0.5rem', boxSizing: 'border-box' }} />
                </div>
              </div>
